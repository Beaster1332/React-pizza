...
let initialState = {
    pizzaCatalog: [
        ...
        { name: 'Маргарита', weight: '500 гр', description: 'Типичная неаполитанская пицца, приготовленная из помидоров Сан-Марцано, сыра моцарелла, свежего базилика, соли и оливкового масла первого отжима.', price: 250, id: 4, src: 'https://img.taste.com.au/DhThzPm9/taste/2016/11/eat-pray-love-39581-3.jpeg' },
        { name: 'Охотничья', weight: '550 гр', description: 'Тонкая пицца с добавлением обильного количества охотничьих колбасок, сыра, а также соуса. Колбаса очень вкусна, сыр даёт тонкие нотки игры на гитаре.', price: 300, id: 5, src: 'https://papitospizza.ru/wa-data/public/shop/products/25/00/25/images/282/282.320@2x.jpg' },
        { name: 'Гавайская', weight: '450 гр', description: 'Самая что ни на есть специфическая пицца, которую может полюбить отнюдь не каждый. Всё негодование любителей пиццы обосновано наличием в пицце ананасов.', price: 325, id: 6, src: 'https://cdn.lifehacker.ru/wp-content/uploads/2021/01/1_1611130322-e1611130395948-1280x640.jpg' },
        { name: 'Маргарита', weight: '500 гр', description: 'Типичная неаполитанская пицца, приготовленная из помидоров Сан-Марцано, сыра моцарелла, свежего базилика, соли и оливкового масла первого отжима.', price: 250, id: 7, src: 'https://img.taste.com.au/DhThzPm9/taste/2016/11/eat-pray-love-39581-3.jpeg' },
        { name: 'Охотничья', weight: '550 гр', description: 'Тонкая пицца с добавлением обильного количества охотничьих колбасок, сыра, а также соуса. Колбаса очень вкусна, сыр даёт тонкие нотки игры на гитаре.', price: 300, id: 8, src: 'https://papitospizza.ru/wa-data/public/shop/products/25/00/25/images/282/282.320@2x.jpg' },
        { name: 'Гавайская', weight: '450 гр', description: 'Самая что ни на есть специфическая пицца, которую может полюбить отнюдь не каждый. Всё негодование любителей пиццы обосновано наличием в пицце ананасов.', price: 325, id: 9, src: 'https://cdn.lifehacker.ru/wp-content/uploads/2021/01/1_1611130322-e1611130395948-1280x640.jpg' },
    ],
    clientCart: [],
    isCartOpen: false,
    isSnackOpen: false,
